...
data class RModel(
    ...
    companion object CREATOR : Parcelable.Creator<RModel> {
        override fun createFromParcel(parcel: Parcel): RModel {
            return RModel(parcel)
        }

        override fun newArray(size: Int): Array<RModel?> {
